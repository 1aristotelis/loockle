    ...
    <>
          {!seedInputScreen ? (<div className="flex-col p-5 sm:rounded-lg bg-base-100">
            ...
            <button
              ...
              className={`bg-base-200 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "twetch" ? "border-2 border-primary" : "border-none"}`}
            >
              <svg
                viewBox="0 0 102 110"
                fill="none"
            ...
            <button
              ...
              className={`bg-base-200 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "local" ? "border-2 border-primary" : "border-none"}`}
            >
